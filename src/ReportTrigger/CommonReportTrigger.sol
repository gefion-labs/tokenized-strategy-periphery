 ...
 *  to decide if Gefion strategies should report profits as
 *  well as when a Vault should record a strategies profits.
 *
...
contract CommonReportTrigger is Governance {
    ...
    string public name = "Gefion Common Report Trigger";
